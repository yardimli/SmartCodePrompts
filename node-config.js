...
function get_main_page_data () {
	...
	// NOTE: Project-specific settings (allowed_extensions, etc.) are no longer sent from here.
	// They are loaded when a project is selected.
	return {
		projects,
...
module.exports = {
	...
	get_default_settings_yaml, // NEW (implementation changed)
	get_default_settings_object, // NEW (implementation changed)
	set_dark_mode,
